...
class DetectionFaceBlurOutputLayer : public Layer<Dtype> {
 public:
  explicit DetectionFaceBlurOutputLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DetectionFaceBlurOutput"; }
 ...
 protected:
   ...
   * @param top output Blob vector (loccluth 1)
