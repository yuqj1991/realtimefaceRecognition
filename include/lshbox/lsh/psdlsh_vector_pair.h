 ...
 */
typedef std::vector<float> featureUnit;
typedef std::pair<featureUnit, std::string> dataUnit; 

template<typename DATATYPE = float>
class PSD_VECTOR_LSH
{
public:
    struct Parameter
    {
    ...
    PSD_VECTOR_LSH() {}
    PSD_VECTOR_LSH(const Parameter &param_)
    {
        reset(param_);
    }
    ~PSD_VECTOR_LSH() {}
     ...
     *
     * @param param_ A instance of PSD_VECTOR_LSH<featureUnit>::Parametor, which contains
     ...
     * Hash the dataset.
     *
     * @param data A instance of Matrix<featureUnit>, it is the search dataset.
     */
    void hash(std::vector<dataUnit> &data);
    /**
     ...
     */
    unsigned getHashVal(unsigned k, const featureUnit domin);
    /**
...
void lshbox::PSD_VECTOR_LSH<DATATYPE>::reset(const Parameter &param_)
{
    param = param_;
...
template<typename DATATYPE>
void lshbox::PSD_VECTOR_LSH<DATATYPE>::hash(std::vector<dataUnit> &data)
{
...
template<typename DATATYPE>
void lshbox::PSD_VECTOR_LSH<DATATYPE>::load(const std::string &file)
{
...
template<typename DATATYPE>
void lshbox::PSD_VECTOR_LSH<DATATYPE>::save(const std::string &file)
{
